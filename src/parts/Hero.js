		...
		<section className='container pt-4'>
			...
			<div className='row align-items-center'>
				<div className='col-auto pr-5' style={{ width: 530 }}>
					...
					<p
						className='mt-4 font-weight-ligth text-gray-500 w-75'
						style={{ lineHeight: "172%" }}>
						Kami menyediakan apa yang Anda butuhkan untuk menikmati liburan Anda
						bersama keluarga
					</p>
					<Button
						className='btn px-5 mt-5 mb-5'
						hasShadow
						isPrimary
				...
				<div className='col mr-5 mb-5 pb-5 px-5'>
					<div className='image-hero' style={{ height: 190, marginLeft: 150 }}>
						...
						<img
							src={HeroImageFrame}
							alt='room tour couches frame'
							className='img-fluid position-absolute'
							style={{ margin: "0 -15px -15px 0", height: 350, width: 430 }}
						/>
					</div>
				</div>
			</div>
